package tn.iteam.gestion_rh.config;

import tn.iteam.gestion_rh.service.MyUserDetailService;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(registry -> {
                    registry.requestMatchers("/signup/**", "/css/**", "/js/**", "/images/**", "/plugins/**").permitAll();
